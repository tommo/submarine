...
class SubmarineTerminalInsertCommand(sublime_plugin.TextCommand):

    def run(self, edit, point, character):
        self.view.insert(edit, point, character)


class SubmarineTerminalTrimTrailingLinesCommand(sublime_plugin.TextCommand):
...
class SubmarineTerminalNukeCommand(sublime_plugin.TextCommand):
